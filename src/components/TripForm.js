  ...
  return (
    <div className=" flex flex-wrap flex-col  justify-center gap-4">
      ...
      >
        ...
        <option value="1 pepole">1 pepole</option>
        <option value="2 pepole">2 pepole</option>
        <option value="3 pepole">3 pepole</option>
        <option value="4 pepole">4 pepole</option>
        <option value="5 pepole">5 pepole</option>
        <option value="6 pepole">6 pepole</option>
        <option value="7 pepole">7 pepole</option>
      </select>
